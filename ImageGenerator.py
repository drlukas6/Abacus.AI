...
class ImageGenerator:
    ...
    def generate_examples_for_text(self, text, number_of_examples):
        fonts_to_use = set()
        while len(fonts_to_use) < number_of_examples:
            ...
            if 'DS_Store' not in random_font_location:
                fonts_to_use.add(random_font_location)
        for i in range(0, number_of_examples):
            ...
            generated_image = self.generate_text_image(font=fonts_to_use.pop(),
